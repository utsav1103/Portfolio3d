...
<motion.div 
            ...
            initial="hidden"
            animate="show"
             className="w-full px-2 xs:p-0 xs:w-max flex flex-col space-y-4 items-start  xs:items-center justify-center relative  group">
            ...
            initial="hidden"
            animate="show"
             className="w-full px-2 xs:p-0 xs:w-max flex flex-col space-y-4 items-end  xs:items-center justify-center relative  group">
